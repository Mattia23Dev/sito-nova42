                        ...
                        <div className="row">
                            <div className="d-flex flex-column justify-center col-12 col-md-8 col-lg-10 mx-auto subtitle-candidati">
                                <FadeLeft delay={1}>
                                    ...
                                    <p className="text-white size-16 weight-400 text-center mt-4">Fissa obiettivi, controlla statistiche, vendite e genera rapporti più esaustivi</p>
                                </FadeLeft>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="row row-nova m-0">
                        <div className="col-12 col-md-8 mb-5 order-1 order-1 order-lg-1 px-4">
                            <FadeLeft delay={2}>
                                ...
                                <h5 className="text-dark size-16 weight-400 mt-2 lh-35">ti accompagniamo nella creazione del software per la tua attività, <br/> dal primo incontro al rilascio e assistenza per manutenzione</h5>
