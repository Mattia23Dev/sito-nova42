...
const ScopriNovaLight = ({customClass=''})=>{
    ...
    return(
        <div className={`w-100 ${customClass}`}>
            <h5 className="gradient-fill size-18 size-md-22 weight-700 text-center mt-3 mb-3 mb-md-2">Sei già pronto per avviare la tua carriera da programmatore?</h5>
            <h2 className="text-dark size-30 size-md-40 weight-700 text-center">Scopri i nostri percorsi formativi</h2>
            ...
            <div className="row mt-4 pb-5">
                <div className="form-group col-12 col-md-4 mx-auto">
                    <div className="form-check">
                        ...
                        <label className="form-check-label size-12" htmlFor="gridCheck">
                            Ho letto e accettato i termini e le condizioni di Nova42
                        </label>
                    </div>
                </div>
                <div className="d-flex justify-content-center align-content-center">
                    ...
                    {
                        disabled && (<button className="btn btn-nova-fill size-16 mt-3 mx-auto" type="submit" disabled={disabled}>{'Scarica la brochure'}</button>)
                    }
                </div>
            </div>
        </div>)
...
export default ScopriNovaLight;